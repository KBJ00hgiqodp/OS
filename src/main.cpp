...
void mainTask(void *params){
	...
	worker2.start("Worker 2", TASK_PRIORITY + 100);
	worker3.start("Worker 3", TASK_PRIORITY + 200);
	worker4.start("Worker 4", TASK_PRIORITY + 300);
	worker5.start("Worker 5", TASK_PRIORITY + 400);
	worker6.start("Worker 6", TASK_PRIORITY + 500);
	worker7.start("Worker 7", TASK_PRIORITY + 600);
	worker8.start("Worker 8", TASK_PRIORITY + 700);
